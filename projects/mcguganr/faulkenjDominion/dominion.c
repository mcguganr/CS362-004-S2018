...
int playSmithy(int pos, int player, struct gameState *pState);

int playAdventurer(int drawntreasure, int z, int cardDrawn, int temphand[500], int handPos, int currentPlayer,
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    {
    case adventurer:
        return playAdventurer(drawntreasure, z, cardDrawn, temphand, handPos, currentPlayer, state);
    ...
    case outpost:
        return playOutpost(handPos, currentPlayer, state);
...
int playOutpost(int handPos, int currentPlayer, struct gameState *state) {
    //set outpost flag
    state->outpostPlayed = -(state->outpostPlayed);
